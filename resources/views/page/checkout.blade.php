						...
						<div class="your-order">
							...
							<div class="your-order-body" style="padding: 0px 10px">
								...
								<div class="your-order-item">
									...
									<!--  one item	 -->
										<div class="media">
											<img width="25%" src="images/products/{{$product['item']->image}}" alt="" class="pull-left">
											<div class="media-body">
												<p class="font-large">{{$product['item']['name']}}</p>
												<p class="font-large">{{$product['item']->name}}</p>
												<span>{{$product['qty']}}*{{$product['item']['unit_price']}}</span>
												<p> IDSP:"{{$product['item']['id']}}" </p>
											</div>
										</div>
									<!-- end one item -->
									</div>
								...
								<div class="your-order-item">
									...
									<div class="pull-right"><h5 class="color-black">{{number_format(session('cart')->totalPrice,0,",",".")}}đ</h5></div>
									<div class="clearfix"></div>
								</div>
							</div>
							@endif
