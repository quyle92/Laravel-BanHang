		...
		<div class="header-body">
			<div class="container beta-relative">
				...
				<div class="pull-right beta-components space-left ov">
					...
					<div class="beta-comp">
						@if(Session::has('cart') and session('cart')->totalPrice != null)
						<div class="cart">
							<div class="beta-select"><i class="fa fa-shopping-cart"></i> Giỏ hàng: {{session('cart')->totalPrice}} <i class="fa fa-chevron-down"></i></div>
							<div class="beta-dropdown cart-body">
								@foreach($products_cart as $product )
								<div class="cart-item">
									<div class="media">
										<a class="cart-item-delete" href="remove-item/{{$product['item']['id']}}">x</a>
										<a class="pull-left" href="#">
											<img src="images/products/{{$product['item']->image}}" alt=""></a>
					...
					<ul class="l-inline ov">
						...
						<li><a href="#">Sản phẩm</a>
							<ul class="sub-menu">
								...
								<li><a href="loaisp/{{ $loai->id}}">{{$loai->name}}</a></li>
								@endforeach
							</ul>
						</li>
